...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-gray-800 active:scale-[0.98] rounded-sm",
        ...
        minimal: "bg-transparent text-foreground border border-gray-200 hover:border-foreground hover:bg-foreground hover:text-background rounded-sm",
        hero: "bg-foreground text-background hover:bg-gray-800 tracking-wide uppercase text-xs font-medium active:scale-[0.98] rounded-sm",
        disabled: "bg-gray-100 text-gray-400 cursor-not-allowed border border-gray-200 rounded-sm",
      },
      size: {
